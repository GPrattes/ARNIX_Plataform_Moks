...
if (typeof formatBRL !== 'undefined') { window.formatBRL = formatBRL; }
if (typeof setUrgency !== 'undefined') { window.setUrgency = setUrgency; }
if (typeof applyPreset !== 'undefined') { window.applyPreset = applyPreset; }
if (typeof recalcMock !== 'undefined') { window.recalcMock = recalcMock; }
if (typeof salvarPropostaMock !== 'undefined') { window.salvarPropostaMock = salvarPropostaMock; }
